...
def _maximal_results() -> dict:
    ...
    return {
        ...
        "analysis": {
            ...
            "gateway_momentum": {
                "status": "active", "label": "Gateway-momentum OFFERING PROXY label",
            ...
            "corequisite_availability": {
                "status": "active", "label": "Corequisite co-offering STRUCTURE proxy label",
                "first_year_terms": ["2268", "2272"],
                "english": {"identified": True, "course": "ENGL 101", "via": "ge_area_1A",
            ...
            "equity_success_gap": {"status": "active",
                "label": "Equity gap MEASURED aggregate label",
                ...
                "courses": [{"course": "CHEM 101", "reference_subgroup": "All",
                             ...
                             "below_reference": [{"subgroup": "Group B",
            ...
            "minimal_perturbation": {"status": "active",
                ...
                "programs": [{
                    ...
                    "notes": []}],
                "not_assessed": []},
            "contact_hours": {"status": "active",
                "label": "Contact-hour CONFORMANCE proxy label",
                "assessed": 2, "consistent": 1,
                "flagged": [{"course": "PE 1", "per_unit_term_hours": 360.0,
                             "direction": "high", "contact_category": "lecture",
                             "expected_band": [9.0, 27.0]}],
                "used_all_blocks": False,
                "not_assessed": {"no_meeting_time": 1, "missing_units": 0,
                                 "missing_weeks": 0, "category_unknown": 0,
                                 "meeting_block_coverage": "all meeting blocks summed"}},
        },
        "reconciliation": {
